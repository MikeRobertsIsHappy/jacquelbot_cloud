...
sw_list = {'ll', 'haven', "that'll", 'against', 'himself', 'his', 'all', 'very', 'are', 'you', 'feel', 'feeling',
              'some', 'm', "needn't", 'only', 'aren', 'their', 'for', 'between', 'it', 'sound', 'sounds', 'like', 'wondering', 
              'but', "she's", "shan't", 'wouldn', 'then', 'from', 'theirs', "weren't",'i', 'wonder', 'if', 'guess','guessing',
              'does', 'again', 'when', 'its', 'and', 'they', 'under', 'shouldn',
              'than', 'didn', 'more', 'so', 'on', 'nor', 'any', 'into', 'how', 'whom',
              'wasn', 'was',  'hasn', 'don', 'yourselves', 'y', 'doing',
              ...
              'd', 'above', 'can', 'as',  'few', 'is', 're', 'couldn'}